...
export const en: LocaleDict = {
  ...
  ask: {
    ...
    composer: {
      ...
      contextHint: "Includes focus context · replies cite frames",
    },
    empty: {
  ...
  workflows: {
    ...
    empty: {
      ...
      body:
        "After you finish a complex task, Corivo will offer to save it as a workflow so you can rerun the same steps later. Once that surface ships, the workflows you create will appear here.",
    },
    capabilityFooter: {
